...
| [Поиск токсичных комментариев](https://https://github.com/AndyGavrilov/toxic_comments "toxic_comments")| Необходимо cоздать инструмент, который будет искать токсичные комментарии и отправлять их на модерацию. | pandas, sklearn, plotly, matplotlib, lightgbm, nltk |
